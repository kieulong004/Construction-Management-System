...
interface CountChartComponentProps {
...
const CountChartComponent: React.FC<CountChartComponentProps> = ({ data, title, darkMode, tooltip, legend }) => {
  useEffect(() => {
    const textColor = darkMode ? '#fff' : '#000';
    const backgroundColor = darkMode ? "#393835" : "#f0f0f0";

    const chart = echarts.init(document.getElementById('charts3'));
    chart.setOption({
  ...
  return <div id="charts3" style={{ width: "100%", height: "581px" }}></div>;
};
